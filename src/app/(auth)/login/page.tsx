...
const AppleIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12.015 16.3c-.374.523-.833.972-1.473 1.221-.55.216-1.294.24-1.896-.067-.978-.498-1.764-1.557-2.3-2.585-.568-1.078-.96-2.23-.96-3.373 0-1.27.357-2.348.96-3.221.569-.828 1.354-1.386 2.3-1.556.551-.115 1.159-.036 1.66.192.375.166.766.435 1.08.738.03.024.06.048.084.072-.697.51-1.129 1.278-1.129 2.11 0 .97.55 1.832 1.34 2.312.186-.33.28-.684.28-1.044 0-.685-.294-1.314-.812-1.78-.174-.15-.303-.34-.372-.558-.024-.072-.036-.144-.036-.222 0-.21.06-.39.18-.54.125-.15.288-.24.48-.24.342 0 .685.234.873.498.42.583.642 1.35.642 2.293 0 1.294-.432 2.49-1.298 3.585zM15.42 24c2.19 0 3.899-1.274 3.9-1.298-.036.024-1.638-1.02-3.33-1.02-1.716 0-2.83 1.043-3.46 1.043-.655 0-1.999-1.03-3.318-1.03s-2.544.984-3.204.984c-.636 0-1.68-.96-2.856-.96-2.14 0-3.69 1.25-3.69 1.25s1.944 2.054 3.9 2.054c1.128 0 1.944-.984 3.012-.984s1.884.984 3.06.984c1.176 0 2.148-.984 3.252-.984zM18.823 1.328c-.012-.012-.024-.024-.036-.036-1.56-.937-3.444-.937-4.788 0-.012.006-.024.018-.036.024-.012.012-.024.024-.036.036-1.32 1.176-1.8 3.036-1.416 4.74.805.348 1.705.534 2.688.534.983 0 1.883-.186 2.688-.534 1.393-3.073-2.064-5.688-2.064-5.688z"/>
    </svg>
);

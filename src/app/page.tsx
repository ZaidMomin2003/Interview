  ...
  const features = [
    {
      ...
      description: 'Generate optimized resumes tailored to specific job roles.',
    },
    {
    ...
    },
    {
      ...
      title: 'Code Analysis',
      description: 'Receive detailed feedback on your code solutions.',
    },
  ];
      ...
      <header className="sticky top-0 z-50 w-full border-b border-primary/20 bg-background/50 backdrop-blur-sm">
        <div className="container flex h-16 items-center">
          <Link href="/" className="flex items-center gap-2 mr-6">
            ...
            <span className="font-bold font-headline text-lg tracking-widest">
              DevPro Ascent
            </span>
          </Link>
        ...
        <section className="py-24 sm:py-32 md:py-40">
          <div className="container px-4 text-center">
            ...
            <p className="mt-6 max-w-2xl mx-auto text-lg text-muted-foreground">
              ...
              interviews, and accelerate your developer journey.
            </p>
            <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
              <Button size="lg" asChild>
                <Link href="/dashboard">
                  Access The Grid <ArrowRight className="ml-2" />
                </Link>
              </Button>
            </div>
          </div>
          ...
          <div className="container px-4">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="mt-4 text-lg text-muted-foreground">
                Harness cutting-edge tools designed for the modern software
                engineer.
              </p>
            </div>
            <div className="mt-16 grid gap-4 md:grid-cols-3">
              {features.map((feature, i) => (
                <Card
                  key={i}
                  className="bg-card/50 backdrop-blur-sm border-primary/20 hover:border-primary/50 transition-colors duration-300 hover:shadow-lg hover:shadow-primary/20"
                >
                  <CardHeader className="items-center text-center">
                    {feature.icon}
                    <CardTitle className="text-2xl pt-4 font-headline tracking-wider">
                      {feature.title}
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
      ...
      <footer className="bg-transparent border-t border-primary/20">
        <div className="container py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} DevPro Ascent // All rights
            reserved.
          </p>

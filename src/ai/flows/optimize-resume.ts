...
/**
 * @fileOverview An AI agent that optimizes resumes.
 *
...
const OptimizeResumeOutputSchema = z.object({
  optimizedResume: z
    .string()
    .describe('The optimized resume with improved content and formatting.'),
  suggestions: z
    .string()
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert resume optimizer. You will be provided with a resume and a job description.
Your goal is to optimize the resume to increase its chances of landing an interview for the job description.

First, provide an optimized version of the resume with improved content, formatting, and overall effectiveness.
Second, provide specific suggestions for improving the resume. Focus on areas such as content, formatting, keywords, and overall presentation.
